...
const Searchrecipe = ({changed, Search, inputValue, keyPress}) =>{
    return <div className="relative flex justify-end items-center p-4 mdd:px-2 lg:pl-3 smm:pl-0 xsm:py-6 xsm:ml-0">
            ...
            <button onClick={Search} className="px-4 h-10 w-14 xxsm:h-7 xxxsm:w-5 xxsm:px-1 xsm:px-1.5 cursor-pointer xsm:py-1 bg-background1 rounded-xl xsm:rounded-md"><img src={searchIcon} alt="serach" className="xxsm:w-5 xxsm:h-5 mr-0"/></button>
    </div>
}
