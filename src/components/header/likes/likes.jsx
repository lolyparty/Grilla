...
const Likes = ({clicked, likedItems, showLikes, setLikedItems, setFilled}) =>{
    return <div className=" pt-10 mr-4 xxsm:pt-7"> <button className="border-0 flex justify-around text-xl likes focus:outline-none focus:shadow-outline focus:border-blue" onClick={clicked}>
