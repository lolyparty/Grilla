...
const Likes = ({clicked, likedItems, showLikes, setLikedItems, setFilled}) =>{
    return <div className=" pt-10 mr-4 xsm:pt-10.5 xxsm:pt-8"> <button className="border-0 flex justify-around text-xl likes focus:outline-none focus:shadow-outline focus:border-blue" onClick={clicked}>
        <span className="xsm:hidden">Favourite Recipes</span>
        <svg viewBox="0 0 55 49.6" width="35" height="25" className="ml-2 xxsm:ml-0">
