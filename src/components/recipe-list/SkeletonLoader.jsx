...
const SkeletonLoader = ()=>{
    return  (<div className="p-3 flex flex-wrap justify-evenly">
                <div className=" skeleton p-3 flex  my-3 mx-2 shadow-lg bg-white w-96 rounded-2xl relative overflow-hidden"> 
                    <div className="w-16 h-16 rounded-full mt-3 bg-gray-200 "></div>
