...
const RecipeListItem = ({id,image_url,title,publisher,closeLikes})=>{
    return <Link to={`/${id}`} onClick={closeLikes} className="my-3 mx-2 shadow-lg bg-white w-96 p-3 rounded-2xl transition duration-1000 transform hover:scale-101 xxsm:p-2">
